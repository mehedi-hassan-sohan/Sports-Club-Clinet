...
const Navbar = () => {
    ...
    const navOptions = <>
        ...
        <li><Link to="/menu">Class</Link></li>
        <li><Link to="/order/salad">Instructor</Link></li>
            ...
            <div className="navbar max-w-screen-xl bg-black text-white">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0}  className="menu bg-white menu-compact dropdown-content mt-3 p-2 shadow text-black rounded-box w-52">
                            {navOptions}
                        </ul>
                    </div>
